...
class HitboxTester {
    ...
    @Test
    void testGetBounds() {
        final Entity dummyEntity = new DummyEntity(new Vector(1.5, 1.5, 1.5), 0, Vector.ZERO);
    ...
    void testMinTranslation() {
        ...
        final Entity dummyEntity2 = new DummyEntity(new Vector(2.5, 1.5, 2.5), 0, Vector.ZERO);
        ...
        final Entity dummyEntity3 = new DummyEntity(new Vector(100, 100, 100), 0, Vector.ZERO);
